...
import { ArrowLeft, ArrowRight, Upload, Home, Bed, Bath, Calendar, MapPin, DollarSign, Camera, Check } from "lucide-react"
      ...
      case 5:
        return (
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-lg font-semibold text-[#2C3E50] mb-3">Move-in date</label>
                <input 
                  type="date"
              ...
              <div>
                <label className="block text-lg font-semibold text-[#2C3E50] mb-3">Move-out date</label>
                <input 
                  type="date"
